...
const AboutPage = () => {
  ...
  return (
    <div className={`about-page ${mounted ? "mounted" : ""}`}>
      ...
      {/* Add Helmet for SEO */}
      <Helmet>
        <title>About CalVant | ISO Compliance & Risk Management</title>
        <meta
          name="description"
          content="Learn about CalVant, a leading ISO 27001 & 27701 compliance platform. Discover our mission, leadership team, services, and why organizations trust us for risk management and compliance."
        />
      </Helmet>
      ...
      <section className="about-hero-section">
        <div className="about-hero-content">
          ...
          <p className="about-hero-subtitle">
            CalVant empowers organizations to achieve ISO 27001 & 27701
            compliance with modern dashboards, real-time monitoring, and
            intelligent insights. Our platform enables enterprises to streamline
            risk management, automate compliance workflows, and ensure audit
      ...
      <section id="team" className="about-team-section">
        ...
        <div className="about-team-grid">
          ...
          <div className="about-team-card">
            ...
            <p className="about-team-bio">
              Full-stack architect specializing in secure cloud infrastructure
              and enterprise software with AWS & Azure expertise.
            </p>
          </div>
          <div className="about-team-card">
            <div className="about-team-avatar">
            ...
            <p className="about-team-bio">
              CISM certified information security manager with deep experience
              in risk assessment and vendor management across industries.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="benefits" className="about-benefits-section">
        ...
        <div className="about-benefits-grid">
          <div className="about-benefit-card">
            ...
            <p>
              Complete compliance framework with pre-built controls, policies,
              and procedures.
            </p>
          </div>
          <div className="about-benefit-card">
        ...
        <div className="about-features-list">
          <div className="about-feature-item">
            ...
            <div>
              ...
              <p>
                Pre-mapped controls across ISO 27001, ISO 27701, and NIST
                frameworks
              </p>
            </div>
          </div>
          <div className="about-feature-item">
            ...
            <div>
              ...
              <p>
                Continuous monitoring with instant alerts for compliance
                violations
              </p>
            </div>
          </div>
          <div className="about-feature-item">
            ...
            <div>
              ...
              <p>
                Real-time visibility into compliance status, risks, and metrics
              </p>
            </div>
          </div>
          <div className="about-feature-item">
            ...
            <div>
              ...
              <p>
                Auto-generate executive, audit, and stakeholder-specific reports
              </p>
            </div>
          </div>
          <div className="about-feature-item">
            ...
            <div>
              ...
              <p>
                Assign tasks, track progress, and manage approvals in one place
              </p>
            </div>
          </div>
          <div className="about-feature-item">
