...
const SecurityPage = () => {
  ...
  const standards = [
    { name: "ISO 27001", desc: "Information Security Management", icon: ShieldCheck },
    { name: "ISO 27701", desc: "Privacy Information Management", icon: Lock },
    { name: "SOC 2 Type II", desc: "Service Organization Controls", icon: Award },
    { name: "GDPR", desc: "General Data Protection Regulation", icon: Shield },
    { name: "CCPA", desc: "California Consumer Privacy Act", icon: Users },
    { name: "PCI DSS", desc: "Payment Card Industry Data Security", icon: Server },
  ];
  ...
  return (
    <div className={`security-page ${mounted ? "mounted" : ""}`}>
      ...
      <header className="security-header">
        <div className="security-header-content">
          ...
          <nav className="security-header-nav">
            ...
            <ul className={`security-nav-links ${mobileMenuOpen ? "mobile-open" : ""}`}>
              ...
              {!isLoggedIn && (
                  ...
                  <a href="/login" className="security-nav-link security-nav-link-cta" onClick={() => setMobileMenuOpen(false)}>
                    Login
                  </a>
      ...
      <section className="security-hero-section">
        <div className="security-hero-content">
          ...
          <p className="security-hero-subtitle">
            CalVant protects your compliance data with military-grade encryption, continuous monitoring,
            and ISO 27001 certified infrastructure trusted by Fortune 500 companies.
          </p>
      ...
      <section className="security-features-section">
        <div className="security-section-header">
          ...
          <p className="security-section-subtitle">
            Multi-layered defense protecting your most sensitive compliance data 24/7
          </p>
        </div>
      ...
      <section className="security-standards-section">
        <div className="security-section-header">
          <h2 className="security-section-title">Global Compliance Certifications</h2>
          <p className="security-section-subtitle">
            Third-party verified compliance with international security standards
          </p>
        </div>
      ...
      <section className="security-infrastructure-section">
        <div className="security-section-header">
          <h2 className="security-section-title">Secure Cloud Infrastructure</h2>
          <p className="security-section-subtitle">
        ...
        <div className="security-infrastructure-grid">
          <div className="security-infra-card">
            ...
            <p>Multi-region AWS deployment with data residency compliance across EU, US, APAC</p>
          </div>
          <div className="security-infra-card">
            <div className="security-infra-icon">
              <Shield size={24} />
          ...
          <div className="security-infra-card">
            ...
            <p>MongoDB Atlas with encryption, RBAC, automated backups, and audit logging</p>
          </div>
          <div className="security-infra-card">
            <div className="security-infra-icon">
              <Zap size={24} />
            ...
            <h4>API Security</h4>
            <p>OAuth 2.0, JWT tokens, rate limiting, and API gateway protections</p>
          </div>
          <div className="security-infra-card">
            <div className="security-infra-icon">
              <Activity size={24} />
            ...
            <h4>Monitoring</h4>
            <p>24/7 SOC monitoring with CloudWatch, GuardDuty, and Security Hub</p>
          </div>
          <div className="security-infra-card">
            <div className="security-infra-icon">
              <CheckCircle size={24} />
            ...
            <p>Quarterly external pentests and continuous vulnerability scanning</p>
          </div>
        </div>
      </section>
      ...
      <section className="security-incident-section">
        <div className="security-section-header">
          ...
          <p className="security-section-subtitle">
            Proven incident response methodology with dedicated security operations center
          </p>
        </div>
        <div className="security-incident-grid">
          {[
            { number: "01", title: "Detection", desc: "Real-time threat detection with SIEM and anomaly detection" },
            { number: "02", title: "Assessment", desc: "Rapid incident triage and scope determination within 15 minutes" },
            { number: "03", title: "Containment", desc: "Immediate threat isolation and forensic preservation" },
            { number: "04", title: "Eradication", desc: "Complete threat removal and system hardening" },
            { number: "05", title: "Recovery", desc: "Controlled restoration with validation testing" },
            { number: "06", title: "Lessons Learned", desc: "Post-incident analysis and preventive measures" },
          ].map((step, idx) => (
      ...
      <section className="security-trust-section">
        ...
        <p className="security-trust-subtitle">Security leaders choose CalVant for compliance confidence</p>
      ...
      <section className="security-cta-section">
        <div className="security-cta-content">
          <h2 className="security-cta-title">Ready to Secure Your Compliance?</h2>
  ...
  <a href="mailto:security@calvant.com" className="security-cta-primary">
