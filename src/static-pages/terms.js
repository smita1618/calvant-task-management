    ...
    <div className={`terms-page ${mounted ? "mounted" : ""}`}>
      ...
      <header className="terms-header">
        <div className="terms-header-content">
          ...
          <nav className="terms-header-nav">
            ...
            >
              <Menu size={20} className={!mobileMenuOpen ? "block" : "hidden"} />
              <X size={20} className={mobileMenuOpen ? "block" : "hidden"} />
            </button>
            <ul className={`terms-nav-links ${mobileMenuOpen ? "mobile-open" : ""}`}>
              <li>
                <button className="terms-nav-link" onClick={() => scrollToSection("acceptance")}>
                  Acceptance
                </button>
              </li>
              <li>
                <button className="terms-nav-link" onClick={() => scrollToSection("services")}>
                  Services
                </button>
              </li>
              ...
              {!isLoggedIn && (
                <li>
                  <a href="/login" className="terms-nav-link terms-nav-link-cta" onClick={() => setMobileMenuOpen(false)}>
                    Login
                  </a>
                </li>
              )}
      ...
      <section className="terms-hero-section">
        <div className="terms-hero-content">
          ...
          <p className="terms-hero-subtitle">
            Last updated: January 7, 2026. Please read these terms carefully before using CalVant.
          </p>
        </div>
      </section>
      ...
      <section className="terms-toc-section">
        <div className="terms-toc-container">
          ...
          <div className="terms-toc-list">
            <a href="#acceptance" className="terms-toc-link" onClick={() => scrollToSection("acceptance")}>1. Acceptance of Terms</a>
            <a href="#services" className="terms-toc-link" onClick={() => scrollToSection("services")}>2. Description of Services</a>
            <a href="#accounts" className="terms-toc-link" onClick={() => scrollToSection("accounts")}>3. User Accounts & Security</a>
            <a href="#usage" className="terms-toc-link" onClick={() => scrollToSection("usage")}>4. Acceptable Use Policy</a>
            <a href="#payments" className="terms-toc-link" onClick={() => scrollToSection("payments")}>5. Payments & Billing</a>
            <a href="#ip" className="terms-toc-link" onClick={() => scrollToSection("ip")}>6. Intellectual Property</a>
            <a href="#data" className="terms-toc-link" onClick={() => scrollToSection("data")}>7. Data Ownership & Privacy</a>
            <a href="#limitation" className="terms-toc-link" onClick={() => scrollToSection("limitation")}>8. Limitation of Liability</a>
            <a href="#warranty" className="terms-toc-link" onClick={() => scrollToSection("warranty")}>9. Warranties & Disclaimers</a>
            <a href="#termination" className="terms-toc-link" onClick={() => scrollToSection("termination")}>10. Termination</a>
            <a href="#governing" className="terms-toc-link" onClick={() => scrollToSection("governing")}>11. Governing Law</a>
            <a href="#contact" className="terms-toc-link" onClick={() => scrollToSection("contact")}>12. Contact Information</a>
          </div>
        </div>
      </section>
        ...
        <div className="terms-content-container">
          ...
          <section id="acceptance" className="terms-section">
            ...
            <div className="terms-section-content">
              <p>By accessing or using CalVant (the "Service"), you agree to be bound by these Terms of Service ("Terms"), our <a href="/privacy">Privacy Policy</a>, and all applicable laws and regulations.</p>
          ...
          <section id="services" className="terms-section">
            ...
            <div className="terms-section-content">
              <p>CalVant provides a SaaS compliance management platform for ISO 27001, ISO 27701, and related security frameworks. Our platform includes:</p>
              <div className="terms-services-grid">
                <div className="terms-service-item">
                  ...
                  <div>
                    ...
                    <p>Document creation, version control, approval workflows, and distribution tracking</p>
                  </div>
                </div>
                <div className="terms-service-item">
                  <div className="terms-service-icon">
                  ...
                  <div>
                    ...
                    <p>Automated risk identification, analysis, treatment planning, and monitoring</p>
                  </div>
                </div>
                <div className="terms-service-item">
                  <div className="terms-service-icon">
                  ...
                  <div>
                    ...
                    <p>Real-time compliance status, control effectiveness, and audit trail logging</p>
                  </div>
                </div>
              </div>
              <p><strong>Service Levels:</strong> We target 99.9% uptime excluding scheduled maintenance occurring during off-peak hours with advance notice.</p>
            </div>
          </section>
          ...
          <section id="usage" className="terms-section">
            ...
            <div className="terms-section-content">
              <p>You agree NOT to use CalVant for the following prohibited activities:</p>
              ...
              <div className="terms-warning-banner">
                <AlertCircle size={24} />
                <div>
                  <strong>Enforcement:</strong> Violations result in immediate account suspension, data deletion, and potential criminal prosecution.
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="payments" className="terms-section">
            ...
            <div className="terms-section-content">
              <p>All subscription fees are non-refundable except as required by law. Billing is processed via Stripe securely.</p>
              ...
              <p><strong>Late Payments:</strong> Accounts 60+ days overdue incur 1.5% monthly interest and may be suspended. Legal collection fees are your responsibility.</p>
            </div>
          </section>
          ...
          <section id="ip" className="terms-section">
            ...
            <div className="terms-section-content">
              <p><strong>CalVant IP:</strong> All platform content, design, functionality, code, documentation, and branding are owned by CalVant or licensed partners. You receive a limited, non-exclusive, non-transferable license to use the platform.</p>
              <p><strong>User Content:</strong> You retain ownership of documents you upload. By uploading content, you grant CalVant a worldwide license to process, store, and use it for service delivery. We never share your content without explicit consent.</p>
          ...
          <section id="data" className="terms-section">
            ...
            <div className="terms-section-content">
              <p>You retain ownership of your data. CalVant processes your data per our <a href="/privacy">Privacy Policy</a> and Data Processing Agreement (DPA).</p>
          ...
          <section id="limitation" className="terms-section">
            ...
            <div className="terms-section-content">
              <p><strong>Maximum Liability:</strong> CalVant's total liability is limited to fees paid in the past 12 months. This applies to all claims regardless of form of action.</p>
              <div className="terms-liability-box">
                <h5>Excluded Damages:</h5>
                <p>CalVant is NOT liable for indirect, incidental, special, consequential, or punitive damages including:</p>
                <ul>
              ...
              <p><em>Note: Some jurisdictions do not allow these limitations, so they may not apply to you.</em></p>
            </div>
          </section>
          ...
          <section id="warranty" className="terms-section">
            ...
            <div className="terms-section-content">
              <p><strong>AS-IS Provision:</strong> CalVant is provided "AS IS" without warranties of any kind, express or implied.</p>
              ...
              <p><strong>User Responsibility:</strong> You are responsible for backup and disaster recovery of your data. We provide tools but not guarantees.</p>
            </div>
          </section>
          ...
          <section id="governing" className="terms-section">
            ...
            <div className="terms-section-content">
              <p>These Terms are governed by the laws of India, specifically West Bengal, without regard to conflicts of law.</p>
            ...
            <div className="terms-section-content">
              ...
              <div className="terms-contact-cards">
                <div className="terms-contact-card">
                  ...
                  <p><a href="mailto:legal@calvant.com">legal@calvant.com</a></p>
                </div>
                <div className="terms-contact-card">
                  <h5>Support & Technical</h5>
                  <p><a href="mailto:support@calvant.com">support@calvant.com</a></p>
                  <p><a href="tel:+918800000000">+91 8800 000 000</a></p>
                </div>
                <div className="terms-contact-card">
                  <h5>Compliance & Security</h5>
                  <p><a href="mailto:security@calvant.com">security@calvant.com</a></p>
                </div>
              </div>
              <p><strong>Last Updated:</strong> January 7, 2026. CalVant reserves the right to modify these Terms at any time. Changes become effective immediately upon posting.</p>
            </div>
          </section>
      ...
      <section className="terms-cta-section">
        <div className="terms-cta-content">
          ...
          <p className="terms-cta-subtitle">By using CalVant, you agree to these terms and conditions.</p>
      ...
      <footer className="terms-footer">
        <div className="terms-footer-content">
          ...
          <div className="terms-footer-section">
            <h4>Support</h4>
            <ul>
              <li><a href="mailto:support@calvant.com">support@calvant.com</a></li>
              <li><a href="tel:+918800000000">+91 8800 000 000</a></li>
