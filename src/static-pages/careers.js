...
const CareersPage = () => {
  ...
  return (
    <div className={`careers-page ${mounted ? "mounted" : ""}`}>
      {/* SEO */}
      <Helmet>
        <title>Careers at CalVant - Join Our Team of Compliance Experts</title>
        <meta name="description" content="Explore exciting career opportunities at CalVant. Join our team of engineers, security experts, and compliance specialists building enterprise-grade compliance technology." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://calvant.com/careers" />
      </Helmet>
      {/* HEADER */}
