  ...
  const blogPosts = [
    {
      ...
      avatar: "SC",
      readTime: "8 min",
      excerpt: "Learn how to conduct an effective gap analysis for ISO 27001 implementation and identify compliance gaps.",
      icon: BookOpen,
      featured: true,
    ...
    },
    {
      ...
      avatar: "MJ",
      readTime: "12 min",
      excerpt: "Step-by-step guide to implementing a comprehensive risk assessment process in your organization.",
      icon: TrendingUp,
      featured: true,
    ...
    },
    {
      ...
      avatar: "EW",
      readTime: "10 min",
      excerpt: "Understanding data protection obligations and how to implement them effectively in your systems.",
      icon: Shield,
      featured: false,
    ...
    },
    {
      ...
      avatar: "JR",
      readTime: "9 min",
      excerpt: "Create an effective incident response plan to minimize breach impact and ensure rapid recovery.",
      icon: Zap,
      featured: true,
    ...
    },
    {
      ...
      avatar: "DK",
      readTime: "11 min",
      excerpt: "How automation tools accelerate compliance workflows and reduce manual effort by 60%.",
      icon: Brain,
      featured: false,
    ...
    },
    {
      ...
      avatar: "LT",
      readTime: "7 min",
      excerpt: "Best practices for developing effective security awareness programs that engage employees.",
      icon: Users,
      featured: false,
    ...
    },
    {
      ...
      avatar: "RC",
      readTime: "13 min",
      excerpt: "Deep dive into Zero Trust security model and step-by-step implementation strategy.",
      icon: Shield,
      featured: false,
    ...
    },
    {
      ...
      avatar: "AF",
      readTime: "10 min",
      excerpt: "Essential KPIs and metrics to track your compliance program's effectiveness.",
      icon: TrendingUp,
      featured: false,
    ...
    <div className={`blog-page ${mounted ? "mounted" : ""}`}>
      ...
      <header className="blog-header">
        <div className="blog-header-content">
          ...
          <nav className="blog-header-nav">
            ...
            <ul className={`blog-nav-links ${mobileMenuOpen ? "mobile-open" : ""}`}>
              <li>
                ...
                <a href="/about" className="blog-nav-link">About</a>
              
            
                <a href="/terms" className="blog-nav-link">Terms</a>
            
              {!isLoggedIn && (
                <li>
                  <a href="/login" className="blog-nav-link blog-nav-link-cta" onClick={() => setMobileMenuOpen(false)}>
                    Login
                  </a>
                </li>
              )}
      ...
      <section className="blog-hero-section">
        <div className="blog-hero-content">
          ...
          <p className="blog-hero-subtitle">
            Expert insights on ISO 27001, compliance frameworks, risk management, and security best practices.
          </p>
        </div>
      </section>
          ...
          <div className="blog-categories-wrapper">
            <div className="blog-categories-scroll">
              {categories.map((cat) => (
                <button
                  key={cat.value}
                  className={`blog-category-btn ${activeCategory === cat.value ? "active" : ""}`}
      ...
      {filteredPosts.length > 0 && (
        <section className="blog-featured-section">
          <div className="blog-section-header">
            ...
            <p className="blog-section-subtitle">Most read and impactful content from our experts</p>
          </div>
              ...
              return (
                <article key={post.id} className="blog-featured-card">
                  ...
                  <div className="blog-featured-meta">
                    ...
                    <span className="blog-featured-time">{post.readTime} read</span>
                  </div>
      ...
      <section className="blog-posts-section">
        <div className="blog-posts-header">
          ...
          <p className="blog-posts-subtitle">{filteredPosts.length} articles found</p>
        </div>
        {filteredPosts.length > 0 ? (
      ...
      <section className="blog-resources-section">
        <div className="blog-section-header">
          ...
          <p className="blog-section-subtitle">Download guides, templates, and tools to accelerate your compliance journey</p>
        </div>
        <div className="blog-resources-grid">
          <div className="blog-resource-card">
            ...
            <p>Comprehensive guide covering all 114 controls with implementation strategies.</p>
          ...
          <div className="blog-resource-card">
            ...
            <p>Ready-to-use checklist for ISO 27001 implementation and audit preparation.</p>
            <a href="#" className="blog-resource-link">
              <Download size={14} />
              Download
            </a>
          ...
          <div className="blog-resource-card">
            ...
            <p>Professional template for conducting comprehensive risk assessments.</p>
            <a href="#" className="blog-resource-link">
              <Download size={14} />
              Download
            </a>
      ...
      <section className="blog-newsletter-section">
        <div className="blog-newsletter-content">
          ...
          <h2>Stay Updated</h2>
          <p>Get the latest compliance insights, security tips, and industry updates delivered weekly.</p>
      ...
      <section className="blog-cta-section">
        <div className="blog-cta-content  " style={{ color: "#ffffff" }}>
          ...
          <p className="blog-cta-subtitle">
            Schedule a free consultation with our compliance experts to discuss your organization's needs.
          </p>
          <div className="blog-cta-buttons">
            ...
            <a href="/about" className="blog-cta-secondary">Learn More</a>
          </div>
        </div>
      </section>
